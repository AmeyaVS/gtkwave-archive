...
#define WAVE_VERSION_INFO "GTKWave Analyzer v3.3.9 (w)1999-2010 BSI"
 ...
 * $Id$
 * $Log$
 * Revision 1.79  2010/06/25 11:58:56  gtkwave
 * version bump
 *
 * Revision 1.78  2010/06/13 20:37:59  gtkwave
 * added strace repeat count
 *
 * Revision 1.77  2010/06/04 20:26:12  gtkwave
 * version bump
 *
 * Revision 1.76  2010/05/06 15:57:52  gtkwave
 * enable_fast_exit now is enabled by default
 *
 * Revision 1.75  2010/05/03 21:42:16  gtkwave
 * version bump
 *
 ...
 *
 * Revision 1.70  2010/03/07 17:53:58  gtkwave
 * version bump to 3.3.4
 *
 * Revision 1.69  2010/02/18 18:27:33  gtkwave
 * modified clipping slope equation to use doubles for intermediate steps
 *
 * Revision 1.68  2010/02/18 17:27:07  gtkwave
 * extern "C" headers / version bump
 *
 * Revision 1.67  2010/01/22 02:10:49  gtkwave
